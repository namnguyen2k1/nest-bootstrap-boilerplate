...
export class OpenAIAudioService {
  ...
  async transcription(
    ...
    return await this.openAI.audio.transcriptions.create(body, getRequestOptions(options));
  }

  async speech(body: SpeechCreateParams, options?: RequestOptions): Promise<Buffer> {
    const result = await this.openAI.audio.speech.create(body, getRequestOptions(options));
  ...
  async translation(
    ...
    return await this.openAI.audio.translations.create(body, getRequestOptions(options));
  }
}
