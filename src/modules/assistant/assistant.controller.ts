...
export class AssistantController {
  ...
  async getListUserConversations(
    ...
    const result = await this.conversationService.listUserConversation(userId, body);
    return {
  ...
  async deleteConversation(@Param("conversationId", MongoIdPipe) conversationId: string) {
